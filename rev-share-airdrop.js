...
var fs = require('fs');
var arbitrum_rpc = 'https://arbitrum-one.publicnode.com';
var optimism_rpc = 'https://optimism.publicnode.com';
...
function getUserInput() {
    return new Promise((resolve) => {
        rl.question('Enter the amount of ETH for the last Epoch: ', (input) => {
            rl.close();
            resolve(input);
        });
    });
...
async function loadHolders() {
    ...
    tokens_in_epoch = await getUserInput();
    console.log("ETH in last Epoch: ", tokens_in_epoch);
